...
{"year":2040,"event":"Still climbing poles. Gravity, weather, and electricity don't negotiate with algorithms."}]},
  ...
  {"title":"stripper","aliases":["exotic dancer","pole dancer","go-go dancer","lap dancer"],"daysUntilCooked":3500,"confidence":3,"cookedLevel":"RAW","description":"Your job is literally being a human body in motion. AI can generate images and deepfakes all day long, but nobody is stuffing dollar bills into a monitor. The entire business model is built on physical presence, eye contact, and the illusion that you find the customer interesting. No algorithm replicates that hustle.","milestones":[{"year":2028,"event":"AI-generated virtual strip clubs exist online. Your regulars still show up in person because they're lonely, not logical."},{"year":2031,"event":"Humanoid robots attempt pole dancing. They're technically impressive and deeply unsettling. Nobody tips them."},{"year":2035,"event":"VR clubs take some of the online market. You still own the in-person experience. Tips are up because inflation."},{"year":2040,"event":"Still dancing. The world's oldest entertainment doesn't get disrupted by the world's newest technology."}]},
  {"title":"escort","aliases":["companion","courtesan"],"daysUntilCooked":3500,"confidence":3,"cookedLevel":"RAW","description":"You sell the one thing AI fundamentally cannot provide — genuine human physical presence and connection. Chatbots can flirt, AI girlfriends can text sweet nothings, but none of them can show up to a dinner party, laugh at bad jokes in person, or provide actual companionship. The demand is as old as civilization and immune to disruption.","milestones":[{"year":2028,"event":"AI companions handle the 'someone to talk to' market. You handle the 'someone to be there' market. Different products."},{"year":2031,"event":"Humanoid robots exist but fall deep into the uncanny valley. Your humanity is your competitive moat."},{"year":2035,"event":"Some clients prefer AI because it's judgment-free. Others prefer you because you're real. Market segments, not replacement."},{"year":2040,"event":"Still here. The oldest profession didn't survive 10,000 years of civilization to get killed by a chatbot."}]},
  {"title":"sex worker","aliases":["prostitute","hooker","call girl"],"daysUntilCooked":3500,"confidence":3,"cookedLevel":"RAW","description":"The literal oldest profession. It survived the agricultural revolution, the industrial revolution, the internet revolution, and it'll survive the AI revolution too. Your entire value proposition is being a warm human being. AI can generate porn, but it can't be present. Until robots pass the uncanny valley AND the physical intimacy test, you're untouchable.","milestones":[{"year":2028,"event":"AI-generated content floods the internet. Your in-person clients don't care — they never did."},{"year":2031,"event":"Realistic sex robots hit the market. They're expensive, creepy, and require maintenance. You don't."},{"year":2035,"event":"Some market shifts to virtual/AI. The premium for 'real human' actually goes UP. Supply and demand, baby."},{"year":2040,"event":"10,000 years and counting. You've outlasted every empire, every technology, every moral panic. Still here."}]},
  {"title":"cam model","aliases":["camgirl","camboy","webcam model","adult content creator","onlyfans creator","onlyfans model"],"daysUntilCooked":700,"confidence":72,"cookedLevel":"WELL DONE","description":"You're competing with AI-generated faces, bodies, and personalities that don't need sleep, don't have bad days, and can be literally anything the viewer wants. Your advantage is being real — but 'real' is getting harder to prove and easier to fake. The parasocial relationship is your moat, but AI parasocial relationships are getting scarily good.","milestones":[{"year":2026,"event":"AI-generated models already stealing views. You can't tell them from real people. Neither can your subscribers."},{"year":2027,"event":"AI clones of real creators surface. Legal nightmare. Your face is no longer exclusively yours."},{"year":2028,"event":"Interactive AI models respond to chat in real-time. They never get tired, never say no, never have boundaries. Your regulars start drifting."},{"year":2029,"event":"Platforms split: 'verified human' becomes a premium badge. You charge more for being real. The irony is thick."}]},
  {"title":"porn star","aliases":["adult film actor","adult actor","adult entertainer","xxx actor"],"daysUntilCooked":1000,"confidence":60,"cookedLevel":"MEDIUM","description":"AI-generated adult content is already indistinguishable from the real thing. Studios can create infinite performers with perfect bodies who never age, never complain, and never leak DMs. Your saving grace is that a segment of the market will always want 'real' — verified, authentic, human content. The premium niche survives. The volume game is toast.","milestones":[{"year":2026,"event":"AI-generated adult content explodes. Studios cut budgets. Your agent stops returning calls."},{"year":2028,"event":"'Verified human' becomes a category on every platform. Turns out authenticity is a kink now."},{"year":2030,"event":"Major studios go fully AI-generated. Independent creators with loyal fanbases survive on parasocial relationships."},{"year":2032,"event":"The industry is 90% AI content. You're in the artisanal 10%. Like craft beer, but for porn."}]},
  {"title":"phone sex operator","aliases":["phone sex worker","adult hotline","sex hotline"],"daysUntilCooked":100,"confidence":92,"cookedLevel":"BURNT TO A CRISP","description":"You are a voice having a conversation. AI is a voice having a conversation. Except AI never gets bored, never breaks character, speaks every language, and costs 0.001 cents per minute. You were already being replaced before ChatGPT could even say 'what are you wearing.' RIP.","milestones":[{"year":2026,"event":"AI voice clones handle 80% of calls. Callers can't tell. They genuinely cannot tell."},{"year":2027,"event":"The last major phone sex company switches to AI. Margins go from thin to infinite."},{"year":2028,"event":"You're a voice acting coach for AI models now. The irony pays okay."},{"year":2029,"event":"The entire industry is AI. Somewhere, a phone still rings. Nobody answers."}]},
  {"title":"sugar baby","aliases":["sugar daddy girlfriend","kept woman","kept man","trophy wife","trophy husband"],"daysUntilCooked":3000,"confidence":5,"cookedLevel":"RAW","description":"You're paid to exist beautifully in someone's life. AI can't attend the yacht party, wear the designer dress, or make their ex jealous at the charity gala. Your entire job is being a conspicuously attractive human in physical proximity to a wealthy person. Until holograms become solid, you're fine.","milestones":[{"year":2028,"event":"AI companions handle the texting and emotional labor. You handle the showing-up-looking-amazing part. Division of labor."},{"year":2031,"event":"Some sugar daddies switch to AI girlfriends because they're cheaper and don't want a Birkin bag. Your clients aren't those people."},{"year":2035,"event":"Humanoid robots at galas. Security removes them. You sip champagne and smirk."},{"year":2040,"event":"Wealth inequality ensures your profession thrives. AI made the rich richer. They still need arm candy."}]},
  {"title":"dominatrix","aliases":["domme","mistress","pro domme","professional dominatrix","femdom"],"daysUntilCooked":3200,"confidence":5,"cookedLevel":"RAW","description":"You command authority, wield implements, read body language in real-time, and provide an intensely physical, psychological experience. AI can roleplay over text — and some clients love that — but the ones who pay premium rates need to physically kneel before a real human. Power dynamics require a real power holder. You are the last job AI will replace.","milestones":[{"year":2028,"event":"AI domme chatbots handle the casual market. Your clients consider them cute. Then book their usual Thursday appointment."},{"year":2031,"event":"VR dungeon experiences emerge. They're a gateway drug, not a replacement. Your booking rate goes up."},{"year":2035,"event":"Someone builds a robot domme. It malfunctions during a session. Lawsuit city. You send a thank-you card."},{"year":2040,"event":"Still here. Still terrifying. Still fully booked. Some jobs are human by definition."}]}];
