...
// HEALTHCARE
  ...
  {"title":"actuaries","aliases":["actuary"],"daysUntilCooked":442,"confidence":79,"cookedLevel":"WELL DONE","description":"You crunch numbers about when people will die. AI does this faster, cheaper, and without needing coffee breaks. Statistical modeling and risk prediction are literally what machine learning was born for. Your TI-84 can't save you now.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"announcers and djs","aliases":["dj","announcer","radio host","radio dj","disc jockey"],"daysUntilCooked":673,"confidence":72,"cookedLevel":"WELL DONE","description":"Half your job is talking into a mic, half is vibing with a crowd. AI can generate playlists, mix tracks, and do radio commentary — but it can't hype up a drunk wedding crowd at 1am. Your mic hand is safe. Your editing job? Not so much.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"anthropologists and archeologists","aliases":["anthropologist","archeologist","archaeologist"],"daysUntilCooked":1140,"confidence":50,"cookedLevel":"MEDIUM","description":"AI can analyze pottery shards and translate ancient texts faster than your whole department. But it can't dig in the dirt, brush off a 3,000-year-old skull, or get dysentery at a remote dig site. Your Indiana Jones cosplay is safe — your desk work isn't.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  ...
  {"title":"audiologists","aliases":["audiologist","hearing specialist"],"daysUntilCooked":1433,"confidence":37,"cookedLevel":"WARMING UP","description":"You peer into ear canals, scrape out wax, and fit hearing aids — none of which AI can do through a screen. AI might read your audiograms better than you, but it can't wrestle a hearing aid into a 85-year-old's ear canal while they tell you about their grandkids.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  ...
  {"title":"biochemists and biophysicists","aliases":["biochemist","biophysicist"],"daysUntilCooked":699,"confidence":69,"cookedLevel":"WELL DONE","description":"AlphaFold already did in hours what took your field decades. AI designs molecules, predicts protein structures, and runs simulations while you're still pipetting. Your wet lab skills buy you time, but the computational side of your job is already AI territory.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  ...
  {"title":"cartographers and photogrammetrists","aliases":["cartographer","mapmaker"],"daysUntilCooked":366,"confidence":81,"cookedLevel":"WELL DONE","description":"Your entire job is turning location data into pretty maps and reports. AI eats geospatial data for breakfast. Satellite imagery analysis, terrain modeling, data visualization — all automated. Google Maps did more for cartography than your degree.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  ...
  {"title":"compensation, benefits, and job analysis specialists","aliases":["compensation analyst","benefits analyst","hr analyst"],"daysUntilCooked":407,"confidence":78,"cookedLevel":"WELL DONE","description":"You research salaries, design benefits packages, and write reports about compensation. AI does all of this in seconds. Every spreadsheet you touch, every market analysis you run — there's an AI tool that does it faster and doesn't need its own benefits package.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"computer programmers","aliases":["programmer","computer programmer"],"daysUntilCooked":242,"confidence":87,"cookedLevel":"BURNT TO A CRISP","description":"Lmao. You write code for a living and the AI that's replacing you was literally trained on your GitHub commits. Copilot already writes half your code. Claude writes the other half. You're basically a copy-paste middleman with imposter syndrome. The call is coming from inside the house.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  ...
  {"title":"cost estimators","aliases":["cost estimator","estimator"],"daysUntilCooked":353,"confidence":79,"cookedLevel":"WELL DONE","description":"You look at blueprints and guess how much things cost. AI looks at every blueprint ever made and guesses better. Historical cost data + pattern matching = your job description is literally an AI use case. Start padding your estimates while you still can.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"credit counselors","aliases":["credit counselor"],"daysUntilCooked":658,"confidence":75,"cookedLevel":"WELL DONE","description":"You tell broke people how to be less broke. AI can analyze their finances, build a budget, and explain debt consolidation without judging them for buying a boat. ChatGPT is already a better financial therapist than most of your coworkers.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"customer service representatives","aliases":["customer service","customer support","csr","call center","call centre"],"daysUntilCooked":317,"confidence":91,"cookedLevel":"BURNT TO A CRISP","description":"You read from a script, transfer calls, and apologize for things that aren't your fault. AI already does this — and customers honestly can't tell the difference. The chatbot doesn't need bathroom breaks or mental health days from being yelled at by strangers.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  ...
  {"title":"desktop publishers","aliases":["desktop publisher","typesetter"],"daysUntilCooked":245,"confidence":85,"cookedLevel":"BURNT TO A CRISP","description":"You turn napkin sketches into CAD files. AI now turns napkin sketches into CAD files. See the problem? Generative design tools are making your mouse clicks obsolete. You're basically a human .DWG converter and the software update just dropped.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"drafters","aliases":["drafter","draftsman","cad drafter","cad technician"],"daysUntilCooked":256,"confidence":92,"cookedLevel":"BURNT TO A CRISP","description":"You turn napkin sketches into CAD files. AI now turns napkin sketches into CAD files. See the problem? Generative design tools are making your mouse clicks obsolete. You're basically a human .DWG converter and the software update just dropped.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  ...
  {"title":"epidemiologists","aliases":["epidemiologist"],"daysUntilCooked":543,"confidence":67,"cookedLevel":"WELL DONE","description":"You track diseases through data. AI tracks diseases through data but faster and without needing a PhD. Pattern recognition in outbreak data is basically what machine learning was designed for. COVID showed the world needs epidemiologists — AI showed it might not need as many.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"exercise physiologists","aliases":["exercise physiologist","exercise scientist"],"daysUntilCooked":1360,"confidence":38,"cookedLevel":"WARMING UP","description":"You strap electrodes to people and make them run on treadmills until they beg for mercy — all in the name of science. AI can analyze the data from your stress tests, but it can't physically catch a cardiac patient who's about to faceplant off the treadmill. Your job is hands-on in the most literal sense.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  ...
  {"title":"military careers","daysUntilCooked":1378,"confidence":42,"cookedLevel":"WARMING UP","description":"Drones already handle reconnaissance, AI plans logistics, and autonomous weapons are not science fiction. But someone still has to kick down doors, carry wounded teammates, and make split-second moral decisions under fire. The Pentagon wants AI everywhere — except in the body bag.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"nuclear medicine technologists","aliases":["nuclear medicine technologist"],"daysUntilCooked":1436,"confidence":44,"cookedLevel":"WARMING UP","description":"You inject people with radioactive material, operate million-dollar gamma cameras, and position patients who can barely stand. AI reads the scans better than you — but it can't prep a radiopharmaceutical dose, calm a claustrophobic patient, or handle a spill of technetium-99m. Your job is literally too radioactive for robots.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"opticians","aliases":["optician"],"daysUntilCooked":1351,"confidence":36,"cookedLevel":"WARMING UP","description":"You measure faces, bend frames with tiny pliers, and teach old people how to put in contacts without poking their eyes out. AI can recommend lenses from a prescription — but it can't adjust your crooked glasses or stop you from choosing frames that make you look like a serial killer.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"orthotists and prosthetists","aliases":["orthotist","prosthetist","prosthetics"],"daysUntilCooked":1293,"confidence":43,"cookedLevel":"WARMING UP","description":"You literally build custom body parts for people. You cast molds, sculpt prosthetic limbs, and fine-tune braces until they fit perfectly. AI helps with 3D modeling and design, but you're still the one physically fitting a prosthetic leg and watching someone take their first steps in it. That's not getting automated.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  ...
  {"title":"podiatrists","aliases":["podiatrist","foot doctor"],"daysUntilCooked":1591,"confidence":41,"cookedLevel":"WARMING UP","description":"You're a doctor... for feet. You perform surgery, trim ingrown toenails, and deal with diabetic ulcers that would make most people gag. AI can diagnose from images, but it can't physically cut into a bunion or fit a custom orthotic. Nobody's building a foot surgery robot when regular surgery robots still cost millions.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"public relations specialists","daysUntilCooked":408,"confidence":78,"cookedLevel":"WELL DONE","description":"You write press releases, draft speeches, and monitor social media sentiment. AI does literally all of this — better, faster, and without the $200 'media lunch.' LLMs were born to write PR fluff. Your entire career is a prompt template. The crisis management part buys you time, but even that's getting automated.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"public safety telecommunicators","aliases":["911 operator","911 dispatcher","dispatcher"],"daysUntilCooked":687,"confidence":74,"cookedLevel":"WELL DONE","description":"You answer 911 calls, process emergencies, and dispatch help — which is basically pattern matching under pressure. AI already triages calls, transcribes in real-time, and dispatches the nearest unit faster than you can say 'what's your emergency.' The emotional support part is real, but AI is getting weirdly good at that too.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"radiologic and mri technologists","aliases":["radiologist","x-ray technician","mri technician","radiologic technologist"],"daysUntilCooked":1460,"confidence":41,"cookedLevel":"WARMING UP","description":"You position patients, operate the MRI machine, and inject contrast dye — all physical tasks AI can't touch. But AI reads the scans better than most radiologists now, which means the 'tech' part of your job is growing while the 'analysis' part is shrinking. You're safe as long as someone needs to physically shove a patient into a giant magnet.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"rehabilitation counselors","aliases":["rehab counselor","rehabilitation counselor"],"daysUntilCooked":1169,"confidence":49,"cookedLevel":"MEDIUM","description":"You write rehab plans, maintain records, and research resources — all stuff AI does faster than you. But you also sit across from someone who just lost the use of their legs and help them find a reason to keep going. AI can draft the paperwork. It can't hold that space. The emotional labor is your moat.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"school and career counselors and advisors","aliases":["school counselor","career counselor","guidance counselor"],"daysUntilCooked":865,"confidence":63,"cookedLevel":"MEDIUM","description":"Half your job is looking stuff up and filling out forms — AI territory. The other half is talking a crying 16-year-old out of dropping out. AI chatbots are already doing college advising better than most guidance counselors, but nobody wants to tell a robot about their parents' divorce. That human connection is buying you time.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"skincare specialists","daysUntilCooked":1518,"confidence":28,"cookedLevel":"WARMING UP","description":"You smear stuff on people's faces, extract blackheads, and recommend serums that cost more than rent. No robot has the touch for a good facial, and half your job is convincing someone their $400 moisturizer is 'totally worth it.' AI can analyze skin — but it can't do extractions or sell the upsell.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"sociologists","aliases":["sociologist"],"daysUntilCooked":597,"confidence":73,"cookedLevel":"WELL DONE","description":"You study society. With data analysis, surveys, and literature reviews — all things AI does in its sleep. Your qualitative research skills are nice, but AI synthesizes 10,000 papers before you finish your abstract. The academic job market was already brutal. AI just brought a flamethrower to a knife fight.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  ...
  {"title":"training and development specialists","aliases":["training specialist","learning and development","l&d specialist"],"daysUntilCooked":617,"confidence":71,"cookedLevel":"WELL DONE","description":"You design training manuals, build e-learning modules, and assess development needs. AI generates entire training courses in minutes — with quizzes, videos, and personalized learning paths. You're a content creator competing with a machine that never sleeps and doesn't need 'stakeholder alignment meetings.'","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"umpires, referees, and other sports officials","aliases":["referee","umpire","sports official"],"daysUntilCooked":921,"confidence":53,"cookedLevel":"MEDIUM","description":"Hawk-Eye already calls the lines better than you do. VAR reviews plays frame-by-frame. AI tracks every ball, step, and foul in real time. But sports need a human to yell at — half the entertainment is arguing with the ref. You're kept around for drama, not accuracy. That's either job security or an insult.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
