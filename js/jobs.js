...
// HEALTHCARE
  ...
  {"title":"actuaries","aliases":["actuary"],"daysUntilCooked":442,"confidence":79,"cookedLevel":"WELL DONE","description":"Actuarial work is fundamentally digital, involving the analysis of large datasets, statistical modeling, and financial forecasting—all areas where AI and machine learning excel.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"announcers and djs","aliases":["dj","announcer","radio host","radio dj","disc jockey"],"daysUntilCooked":673,"confidence":72,"cookedLevel":"WELL DONE","description":"The occupation is split between highly exposed digital work and less exposed physical work.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"anthropologists and archeologists","aliases":["anthropologist","archeologist","archaeologist"],"daysUntilCooked":1140,"confidence":50,"cookedLevel":"MEDIUM","description":"This occupation is a hybrid of physical fieldwork and digital knowledge work. While AI can significantly automate data analysis, pattern recognition in artifacts, and report writing, it cannot replace the physical requirements of excavation, site surveying, and in-person ethnographic observation.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"assemblers and fabricators","aliases":["assembler","fabricator"],"daysUntilCooked":1885,"confidence":29,"cookedLevel":"WARMING UP","description":"The core of this occupation involves physical manipulation, manual dexterity, and real-time adjustments in a physical environment, which provides a significant buffer against AI.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"audiologists","aliases":["audiologist","hearing specialist"],"daysUntilCooked":1433,"confidence":37,"cookedLevel":"WARMING UP","description":"Audiology is a clinical healthcare profession that requires physical presence for examinations, wax removal, and fitting hardware like hearing aids or cochlear implants.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"automotive body and glass repairers","daysUntilCooked":2265,"confidence":22,"cookedLevel":"RAW","description":"The core tasks are highly physical, involving manual dexterity, welding, and the use of pneumatic tools in unpredictable repair environments that are difficult to automate.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"barbers, hairstylists, and cosmetologists","daysUntilCooked":2472,"confidence":17,"cookedLevel":"RAW","description":"The core of this occupation involves manual dexterity and physical interaction in a highly unpredictable environment (human hair and skin).","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"biochemists and biophysicists","aliases":["biochemist","biophysicist"],"daysUntilCooked":699,"confidence":69,"cookedLevel":"WELL DONE","description":"This occupation is heavily centered on knowledge work, data analysis, and complex modeling, all of which are being revolutionized by AI (e.g., AlphaFold for protein structure prediction).","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"boilermakers","daysUntilCooked":2446,"confidence":20,"cookedLevel":"RAW","description":"The core work is highly physical, involving manual assembly, welding, and repair in unpredictable and cramped environments like boilers and tanks.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"cartographers and photogrammetrists","aliases":["cartographer","mapmaker"],"daysUntilCooked":366,"confidence":81,"cookedLevel":"WELL DONE","description":"The core tasks of collecting, analyzing, and visualizing geospatial data are fundamentally digital and highly susceptible to AI-driven automation.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"chefs and head cooks","aliases":["head cook"],"daysUntilCooked":1906,"confidence":32,"cookedLevel":"WARMING UP","description":"The core of the job is highly physical and sensory, requiring manual dexterity, real-time human leadership in a fast-paced kitchen, and the use of taste and smell.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"chiropractors","aliases":["chiropractor"],"daysUntilCooked":1932,"confidence":27,"cookedLevel":"WARMING UP","description":"The core of chiropractic work is highly physical, requiring manual dexterity for spinal adjustments and real-time physical assessment of a patient's musculoskeletal system.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"compensation, benefits, and job analysis specialists","aliases":["compensation analyst","benefits analyst","hr analyst"],"daysUntilCooked":407,"confidence":78,"cookedLevel":"WELL DONE","description":"This occupation is fundamentally digital and data-driven, involving core tasks like market research, cost analysis, and report generation that align perfectly with AI's strengths.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"computer programmers","aliases":["programmer","computer programmer"],"daysUntilCooked":242,"confidence":87,"cookedLevel":"BURNT TO A CRISP","description":"The core tasks of writing, testing, and debugging code are entirely digital and align perfectly with the strengths of Large Language Models, which are already highly proficient in these domains.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"concierges","aliases":["concierge","hotel concierge"],"daysUntilCooked":1150,"confidence":50,"cookedLevel":"MEDIUM","description":"The role is a hybrid of digital information processing and physical hospitality.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"cost estimators","aliases":["cost estimator","estimator"],"daysUntilCooked":353,"confidence":79,"cookedLevel":"WELL DONE","description":"Cost estimation is a data-intensive, digital-first occupation centered on analyzing blueprints, technical documents, and historical databases to predict costs.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"credit counselors","aliases":["credit counselor"],"daysUntilCooked":658,"confidence":75,"cookedLevel":"WELL DONE","description":"The core tasks of credit counseling—analyzing financial data, creating budgets, and explaining debt management options—are fundamentally digital and information-based, making them highly susceptible to AI automation.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"customer service representatives","aliases":["customer service","customer support","csr","call center","call centre"],"daysUntilCooked":317,"confidence":91,"cookedLevel":"BURNT TO A CRISP","description":"The core duties of this role—answering questions, processing orders, and resolving complaints—are fundamentally digital and information-based, making them highly susceptible to AI-driven automation.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"dancers and choreographers","daysUntilCooked":2244,"confidence":18,"cookedLevel":"RAW","description":"The core of this occupation is physical performance, athleticism, and real-time human interaction in physical spaces, which AI cannot replicate.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"desktop publishers","aliases":["desktop publisher","typesetter"],"daysUntilCooked":245,"confidence":85,"cookedLevel":"BURNT TO A CRISP","description":"The work product is entirely digital and involves routine information processing, layout design, and basic editing—all areas where AI is highly proficient.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"drafters","aliases":["drafter","draftsman","cad drafter","cad technician"],"daysUntilCooked":256,"confidence":92,"cookedLevel":"BURNT TO A CRISP","description":"Drafters perform work that is almost entirely digital, converting conceptual sketches into technical CAD and BIM models.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"drywall installers, ceiling tile installers, and tapers","daysUntilCooked":2901,"confidence":15,"cookedLevel":"RAW","description":"The core tasks of this occupation are entirely physical, involving manual labor, dexterity, and movement in unpredictable construction environments.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"electrical and electronics installers and repairers","aliases":["electronics repair","electronics technician"],"daysUntilCooked":1946,"confidence":35,"cookedLevel":"WARMING UP","description":"The core of this occupation involves physical manipulation of hardware, manual troubleshooting in unpredictable environments, and the use of hand tools, which are highly resistant to AI automation.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"electrical power-line installers and repairers","daysUntilCooked":2378,"confidence":18,"cookedLevel":"RAW","description":"The core work is highly physical, involving climbing towers, operating heavy machinery, and manual repair in unpredictable outdoor environments.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"elementary, middle, and high school principals","aliases":["principal","school principal","vice principal","assistant principal"],"daysUntilCooked":974,"confidence":59,"cookedLevel":"MEDIUM","description":"Principals perform significant knowledge work—such as curriculum development, budget management, and data analysis of student performance—that is highly susceptible to AI augmentation and automation.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"elevator and escalator installers and repairers","aliases":["elevator installer","elevator mechanic","elevator technician"],"daysUntilCooked":1623,"confidence":28,"cookedLevel":"WARMING UP","description":"The core of this occupation involves highly physical, manual labor in unpredictable environments, such as elevator shafts and machine rooms, which provides a strong barrier against AI automation.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"emts and paramedics","daysUntilCooked":1727,"confidence":35,"cookedLevel":"WARMING UP","description":"The core of this occupation involves physical intervention, manual dexterity, and real-time human presence in unpredictable environments, which are highly resistant to AI.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"epidemiologists","aliases":["epidemiologist"],"daysUntilCooked":543,"confidence":67,"cookedLevel":"WELL DONE","description":"Epidemiology is a data-intensive knowledge profession where core tasks like statistical analysis, pattern recognition in large datasets, and literature reviews are highly susceptible to AI augmentation.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"exercise physiologists","aliases":["exercise physiologist","exercise scientist"],"daysUntilCooked":1360,"confidence":38,"cookedLevel":"WARMING UP","description":"The role involves a significant amount of physical presence, including conducting stress tests, measuring vital signs with medical equipment, and providing hands-on rehabilitative care.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"flooring installers and tile and stone setters","daysUntilCooked":2761,"confidence":15,"cookedLevel":"RAW","description":"The core duties of this occupation are entirely physical, involving manual dexterity, heavy lifting, and real-time adaptation to irregular physical surfaces in unpredictable environments.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"fundraisers","aliases":["fundraiser"],"daysUntilCooked":689,"confidence":66,"cookedLevel":"WELL DONE","description":"Fundraising involves significant digital work including donor research, data analysis, and the creation of promotional messaging, all of which are highly susceptible to AI automation and enhancement.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"genetic counselors","aliases":["genetic counselor","genetics counselor"],"daysUntilCooked":743,"confidence":58,"cookedLevel":"MEDIUM","description":"Genetic counselors perform high-level knowledge work, including analyzing complex DNA data and medical histories, which is highly susceptible to AI optimization.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"geographers","aliases":["geographer"],"daysUntilCooked":362,"confidence":75,"cookedLevel":"WELL DONE","description":"Geographers primarily perform digital knowledge work, including data analysis, GIS modeling, and report writing, all of which are highly susceptible to AI automation and enhancement.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"glaziers","daysUntilCooked":2206,"confidence":18,"cookedLevel":"RAW","description":"The core work of a glazier is highly physical, requiring manual dexterity, strength, and real-time problem-solving in unpredictable construction environments.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"hand laborers and material movers","daysUntilCooked":2184,"confidence":17,"cookedLevel":"RAW","description":"The core duties of this occupation are fundamentally physical, involving the manual movement, cleaning, and packing of heavy materials in unpredictable real-world environments.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"health education specialists","aliases":["health educator"],"daysUntilCooked":777,"confidence":57,"cookedLevel":"MEDIUM","description":"A significant portion of the role involves digital knowledge work such as analyzing community health data, writing grant proposals, and creating educational materials, all of which are highly susceptible to AI augmentation.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"historians","aliases":["historian"],"daysUntilCooked":643,"confidence":70,"cookedLevel":"WELL DONE","description":"Historians perform high-level knowledge work—researching, analyzing, and writing—that is increasingly digital and highly susceptible to AI-driven efficiency gains in document processing and synthesis.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"human resources specialists","aliases":["hr specialist","hr coordinator","human resources"],"daysUntilCooked":534,"confidence":72,"cookedLevel":"WELL DONE","description":"The core tasks of recruiting, screening, and administrative record-keeping are highly digital and data-driven, making them prime targets for AI automation and augmentation.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"hydrologists","aliases":["hydrologist"],"daysUntilCooked":990,"confidence":61,"cookedLevel":"MEDIUM","description":"Hydrologists have a high exposure to AI because a significant portion of their work involves data analysis, computer modeling, and report writing—tasks where AI is rapidly advancing.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"instructional coordinators","aliases":["instructional coordinator","curriculum developer"],"daysUntilCooked":700,"confidence":69,"cookedLevel":"WELL DONE","description":"Instructional coordinators perform high-level knowledge work including curriculum development, data analysis, and educational material review, all of which are digital-first tasks highly susceptible to AI augmentation.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"ironworkers","daysUntilCooked":2594,"confidence":15,"cookedLevel":"RAW","description":"Ironworking is a highly physical occupation performed in unpredictable, outdoor environments and at great heights, which provides a significant natural barrier to AI and robotics.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"labor relations specialists","aliases":["labor relations","union rep"],"daysUntilCooked":668,"confidence":67,"cookedLevel":"WELL DONE","description":"This occupation is predominantly digital and knowledge-based, involving the drafting of contracts, policy development, and legal compliance—all areas where AI excels.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"logisticians","aliases":["logistician","logistics manager","supply chain manager"],"daysUntilCooked":695,"confidence":69,"cookedLevel":"WELL DONE","description":"Logisticians perform high-level knowledge work that is primarily digital, involving data analysis, forecasting, and supply chain optimization—tasks where AI excels.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"machinists and tool and die makers","aliases":["machinist","tool maker","die maker"],"daysUntilCooked":1524,"confidence":41,"cookedLevel":"WARMING UP","description":"The role involves a significant physical component, including manual dexterity, machine setup, and material handling in a factory environment.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"manicurists and pedicurists","daysUntilCooked":2194,"confidence":21,"cookedLevel":"RAW","description":"The core of this occupation involves high-precision physical labor, tactile sensitivity, and real-time human interaction in a physical environment.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"military careers","daysUntilCooked":1378,"confidence":42,"cookedLevel":"WARMING UP","description":"Military careers are a vast composite of physical combat, manual labor, and high-level digital strategy.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"nuclear medicine technologists","aliases":["nuclear medicine technologist"],"daysUntilCooked":1436,"confidence":44,"cookedLevel":"WARMING UP","description":"The role requires significant physical presence to prepare and administer radiopharmaceuticals, operate heavy machinery, and physically assist or position patients.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"opticians","aliases":["optician"],"daysUntilCooked":1351,"confidence":36,"cookedLevel":"WARMING UP","description":"The role involves a significant amount of physical, hands-on work such as measuring faces, adjusting frames with tools, and teaching patients how to insert contact lenses.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"orthotists and prosthetists","aliases":["orthotist","prosthetist","prosthetics"],"daysUntilCooked":1293,"confidence":43,"cookedLevel":"WARMING UP","description":"This occupation involves a significant amount of physical, hands-on work including patient examinations, manual measurements, and the physical fabrication or adjustment of medical devices.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"phlebotomists","daysUntilCooked":2382,"confidence":20,"cookedLevel":"RAW","description":"The core of the job is a highly tactile, physical procedure (venipuncture) performed on human patients in unpredictable clinical settings, which is resistant to AI automation.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"podiatrists","aliases":["podiatrist","foot doctor"],"daysUntilCooked":1591,"confidence":41,"cookedLevel":"WARMING UP","description":"Podiatry is a medical specialty that requires significant physical presence for exams, manual procedures, and complex surgeries that AI cannot perform.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"public relations specialists","daysUntilCooked":408,"confidence":78,"cookedLevel":"WELL DONE","description":"The core tasks of this occupation—writing press releases, drafting speeches, creating social media content, and monitoring public sentiment—are digital-first and align perfectly with the capabilities of Large Language Models.","milestones":[{"year":2027,"event":"AI handles the routine parts. You do the exceptions."},{"year":2028,"event":"AI handles the exceptions too. You supervise."},{"year":2029,"event":"Companies realize they need 70% fewer of you."},{"year":2030,"event":"The survivors are AI-augmented specialists. Everyone else pivoted."}]},
  {"title":"public safety telecommunicators","aliases":["911 operator","911 dispatcher","dispatcher"],"daysUntilCooked":687,"confidence":74,"cookedLevel":"WELL DONE","description":"The core tasks of this role—receiving digital inputs (voice, text, video), processing information according to protocols, and dispatching resources—are highly susceptible to AI automation and augmentation.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"radiologic and mri technologists","aliases":["radiologist","x-ray technician","mri technician","radiologic technologist"],"daysUntilCooked":1460,"confidence":41,"cookedLevel":"WARMING UP","description":"While AI is revolutionizing image analysis and quality control, the core of this role requires physical presence to position patients, administer contrast agents, and operate heavy machinery in a clinical setting.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"rehabilitation counselors","aliases":["rehab counselor","rehabilitation counselor"],"daysUntilCooked":1169,"confidence":49,"cookedLevel":"MEDIUM","description":"Rehabilitation counseling involves a significant amount of digital knowledge work, such as developing rehabilitation plans, maintaining records, and researching resources, which are highly susceptible to AI assistance.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"school and career counselors and advisors","aliases":["school counselor","career counselor","guidance counselor"],"daysUntilCooked":865,"confidence":63,"cookedLevel":"MEDIUM","description":"This occupation is a mix of high-touch interpersonal work and digital information processing.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"skincare specialists","daysUntilCooked":1518,"confidence":28,"cookedLevel":"WARMING UP","description":"The core of the job involves physical, hands-on treatments like facials, massages, and hair removal that require real-time human presence and manual dexterity.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"sociologists","aliases":["sociologist"],"daysUntilCooked":597,"confidence":73,"cookedLevel":"WELL DONE","description":"Sociology is a knowledge-intensive field where core tasks like data analysis, literature reviews, and report writing are highly susceptible to AI enhancement.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"solar photovoltaic installers","daysUntilCooked":2229,"confidence":18,"cookedLevel":"RAW","description":"The core of this occupation is highly physical, involving manual labor, climbing roofs, and using hand tools in unpredictable outdoor environments.","milestones":[{"year":2029,"event":"AI helps with the boring parts. Your hands still do the work."},{"year":2032,"event":"New tools make you more efficient. You're not going anywhere."},{"year":2035,"event":"Robots tried. They failed. Humans are still better."},{"year":2038,"event":"Still here. Some jobs just need a human."}]},
  {"title":"speech-language pathologists","aliases":["speech pathologist","speech therapist","slp"],"daysUntilCooked":1119,"confidence":54,"cookedLevel":"MEDIUM","description":"Speech-language pathology involves a significant amount of digital-adjacent work, such as analyzing speech patterns, documenting progress, and developing treatment plans, all of which are highly susceptible to AI enhancement.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"substance abuse, behavioral disorder, and mental health counselors","aliases":["substance abuse counselor","addiction counselor","mental health counselor"],"daysUntilCooked":1172,"confidence":48,"cookedLevel":"MEDIUM","description":"This occupation is a mix of high-level knowledge work and intense interpersonal interaction.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"surveyors","aliases":["surveyor","land surveyor"],"daysUntilCooked":1153,"confidence":53,"cookedLevel":"MEDIUM","description":"Surveying is a hybrid occupation that combines significant physical fieldwork with digital data processing.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  {"title":"tellers","aliases":["teller"],"daysUntilCooked":553,"confidence":73,"cookedLevel":"WELL DONE","description":"Tellers face high exposure because their core tasks—processing routine financial transactions and verifying information—are digital in nature and highly susceptible to automation through AI and advanced self-service technology.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"training and development specialists","aliases":["training specialist","learning and development","l&d specialist"],"daysUntilCooked":617,"confidence":71,"cookedLevel":"WELL DONE","description":"Much of the core work, such as designing training manuals, creating online learning modules, and assessing needs through data, is digital and highly susceptible to AI automation and augmentation.","milestones":[{"year":2027,"event":"AI tools become standard in your workflow."},{"year":2029,"event":"AI handles 50% of your daily tasks."},{"year":2031,"event":"Teams shrink. Each person does what three used to."},{"year":2033,"event":"The role evolves significantly. Same title, different job."}]},
  {"title":"umpires, referees, and other sports officials","aliases":["referee","umpire","sports official"],"daysUntilCooked":921,"confidence":53,"cookedLevel":"MEDIUM","description":"The occupation is a hybrid of physical presence and objective data processing.","milestones":[{"year":2028,"event":"AI assists with paperwork, scheduling, and analysis."},{"year":2030,"event":"AI handles the information side. You handle the human side."},{"year":2033,"event":"Demand for your physical/human skills increases."},{"year":2036,"event":"You're more productive with AI, but still essential."}]},
  ...
  {"title":"cto","aliases":["chief technology officer","vp of engineering","svp engineering"],"daysUntilCooked":800,"confidence":55,"cookedLevel":"MEDIUM","description":"You make technical decisions, set architecture strategy, and manage engineering orgs. AI handles architecture reviews, tech stack evaluations, and even code reviews. Your value is in vision, leadership, and the political skill to say no to the CEO's bad ideas.","milestones":[{"year":2027,"event":"AI advises on architecture decisions better than your team."},{"year":2028,"event":"Engineering orgs flatten. You manage AI agents, not just humans."},{"year":2030,"event":"Technical strategy becomes AI-assisted decision-making."},{"year":2032,"event":"You either evolve into an AI-orchestration leader or you're a VP."}]},
  {"title":"cfo","aliases":["chief financial officer","finance director","head of finance"],"daysUntilCooked":700,"confidence":60,"cookedLevel":"WELL DONE","description":"Financial modeling, forecasting, audit, compliance — all increasingly automated. Your remaining value is board communication, investor relations, and the judgment to know when the numbers are lying. AI is your new FP&A team.","milestones":[{"year":2027,"event":"AI handles financial modeling and forecasting."},{"year":2028,"event":"Compliance and audit become largely automated."},{"year":2029,"event":"Your finance team shrinks 60%. AI does the analysis."},{"year":2030,"event":"You're a strategic advisor. The numbers compute themselves."}]},
  {"title":"coo","aliases":["chief operating officer","head of operations"],"daysUntilCooked":700,"confidence":60,"cookedLevel":"WELL DONE","description":"Operations optimization is literally what AI was built for. Supply chain, logistics, process efficiency, workforce planning — all getting automated. Your job becomes managing the humans who manage the AI that manages the operations.","milestones":[{"year":2027,"event":"AI optimizes supply chain and logistics end-to-end."},{"year":2028,"event":"Process automation eliminates 50% of operational overhead."},{"year":2030,"event":"You oversee an AI operations team."},{"year":2032,"event":"COO role merges with CTO at many companies."}]},
  {"title":"vp","aliases":["vice president","senior vice president","svp","evp","executive vice president"],"daysUntilCooked":700,"confidence":55,"cookedLevel":"WELL DONE","description":"The generic corporate VP — you attend meetings, set strategy, and manage managers. AI flattens organizations. Middle executive layers are the first to compress. Your LinkedIn title is impressive but your daily tasks are increasingly automatable.","milestones":[{"year":2027,"event":"AI handles reporting, analysis, and strategic recommendations."},{"year":2028,"event":"Organizations flatten. VP layer compresses."},{"year":2030,"event":"Only VPs with unique expertise or relationships survive."},{"year":2032,"event":"You're either C-suite or IC. Middle executive is gone."}]},
